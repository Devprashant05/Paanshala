...
function PaanScheduleModal({ isOpen, onClose, onConfirm }) {
  ...
  // Generate time slots in 30-min increments (9am - 9pm)
  const timeSlots = [];
  for (let h = 9; h <= 21; h++) {
  ...
  // Filter out time slots that are less than 12 hours from now
  const getAvailableTimeSlots = () => {
    ...
    // Today — filter out slots less than 12 hours from now
          ...
          <div className="space-y-5 pt-2">
            ...
            <div className="flex items-start gap-2.5 p-3.5 bg-amber-50 border border-amber-200 rounded-xl">
              ...
              <p className="text-xs text-amber-800 leading-relaxed">
                ...
                <strong>12 hours advance notice</strong> to prepare. Please plan
                accordingly.
              </p>
            </div>
              ...
              {!selectedDate ? (
                ...
                <div className="p-3 bg-red-50 border border-red-200 rounded-xl">
                  <p className="text-xs text-red-700 flex items-center gap-2">
                    ...
                    No available slots for this date. Please select a later
                    date.
                  </p>
                </div>
              ) : (
