                ...
                <div className="relative flex-1">
                  ...
                  {isSearching && (
                    <div className="absolute right-12 top-1/2 -translate-y-1/2">
                      <Loader2
                        className="w-5 h-5 animate-spin text-gold-bright"
                        strokeWidth={2.5}
                      />
                    </div>
                  )}
  ...
  return (
    <div className="text-center py-20">
      ...
      <p className="text-body text-gray-600 mb-8 max-w-md mx-auto">
        ...
        {searchQuery && <span className="font-bold">"{searchQuery}"</span>}. Try
      ...
      <div className="flex gap-3 justify-center flex-wrap">
        ...
        <Link href="/shop">
          <button className="btn-gold">Browse All Products</button>
        </Link>
      </div>
    </div>
  );
